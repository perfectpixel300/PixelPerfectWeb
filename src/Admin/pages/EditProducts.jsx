                        ...
                        <div className="bg-gray-100/50 p-6 rounded-2xl">
                            <div >
                                ...
                                <div className="price flex flex-col border-t gap-2 w-full border-gray-200 py-1">
                                    ...
                                    <input ref={priceRef} className="p-2  duration-500 bg-gray-200  w-full focus:outline-none rounded-lg text-sm" placeholder="Rs. XXXX" id="price" type="number" step="0.01" />
                                </div>
                            </div>
